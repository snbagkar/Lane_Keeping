...
def camera_callback(data):
    ...
    #ab = cv2.imshow('processed', cropped_image)
    abc = cv2.resize(cropped_image, (400,400))
    cv2.imshow('processed',abc)
#cv2.moveWindow('processed',700,0)
    #cv2.imshow('canny',canny_image)
    can = cv2.resize(canny_image, (400,400))
    ...
    comb = cv2.resize(combo_image, (400,400))
    cv2.imshow('combination',comb)
    #cv2.moveWindow('combo_image',1200,0)
    #cv2.imshow('ROI',cropped_image)
    crop = cv2.resize(cropped_image, (400,400))
